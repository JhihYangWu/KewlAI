...
from animate_anyone.stable_diffusion.ema import LitEma
from animate_anyone.stable_diffusion.distributions import normal_kl, DiagonalGaussianDistribution
from animate_anyone.stable_diffusion.autoencoder import IdentityFirstStage, AutoencoderKL
from animate_anyone.stable_diffusion.modules import FrozenOpenCLIPEmbedder, FrozenOpenCLIPImageEmbedder, CLIPEmbeddingNoiseAugmentation
from animate_anyone.stable_diffusion.openaimodel import UNetModel
from animate_anyone.stable_diffusion.utils import make_beta_schedule, extract_into_tensor, noise_like, log_txt_as_img, exists, default, ismap, isimage, mean_flat, count_params
from animate_anyone.stable_diffusion.ddim import DDIMSampler
...
class ImageEmbeddingConditionedLatentDiffusion(LatentDiffusion):
    ...
    def _init_embedder(self, config, freeze=True):
        embedder = FrozenOpenCLIPImageEmbedder(**config.get("params", dict()))
        if freeze:
    ...
    def _init_noise_aug(self, config):
        if config is not None:
            ...
            noise_augmentor = CLIPEmbeddingNoiseAugmentation(**config.get("params", dict()))
